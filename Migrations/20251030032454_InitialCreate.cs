        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Caballeros Mayores (18 años o más)", "M", "Caballeros - Mayores", null, 18 },
                    { 2, "Damas Mayores (18 años o más)", "F", "Damas - Mayores", null, 18 },
                    { 3, "Mixtos Mayores", "X", "Mixtos - Mayores", null, 18 },
                    { 4, "Juveniles (12 - 17 años)", "X", "Juveniles - Mixtos", 17, 12 },
                    { 5, "Infantiles (hasta 11 años)", "X", "Infantiles", 11, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Confirmed" },
                    { 2, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, "Confirmed" },
                    ...
                    { 5, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 1, "Confirmed" },
                    { 6, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, 1, "Confirmed" },
                    ...
                    { 9, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 9, 1, "Confirmed" },
                    { 10, 3, new DateTime(2025, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 10, 1, "Confirmed" }
                });
